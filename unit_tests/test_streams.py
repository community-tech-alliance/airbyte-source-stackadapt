...
import pytest
from source_stackadapt.source import StackadaptStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(StackadaptStream, "path", "v0/example_endpoint")
    mocker.patch.object(StackadaptStream, "primary_key", "test_primary_key")
    mocker.patch.object(StackadaptStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = StackadaptStream()
